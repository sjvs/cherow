...
export function isIdContinue(ch: number) {
    return (CharacterType[ch] & CharacterFlags.IdentifierStart) != 0;
}

const enum CharacterFlags {
    Unknown             = 0x0,
    ...
    Space               = 0x10,
    LineFeed            = 0x20,
    Whitespace = Space | LineFeed,
    Letters = IdentifierStart | IdentifierLead,
    Hexadecimal = IdentifierStart | IdentifierLead | Hex,
