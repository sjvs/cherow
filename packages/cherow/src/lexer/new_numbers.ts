...
/**
 * Note: This is experimental code, and will not work in current state. Things need to be optimized
 * and cleaned up.
 */
...
export function scanOctalHexOrBinary(parser: Parser, context: Context): Token {
    const next = parser.source.charCodeAt(parser.index);
